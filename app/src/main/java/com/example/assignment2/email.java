                ...
                && !editText2.getText().toString().isEmpty()){
                   /* Intent in=new Intent(Intent.ACTION_SEND);*/
                    ...
                    if(in.resolveActivity(getPackageManager())!=null){
                        ...
                        Toast.makeText(email.this,"There is no app that support such type of action",Toast.LENGTH_LONG).show();
                    }
                }
                else
                {
                    Toast.makeText(email.this,"Please fill all fields",Toast.LENGTH_LONG).show();
                }
            }
        });
